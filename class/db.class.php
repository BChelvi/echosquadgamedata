...
class Db
 {
    ...
    //propriété de l'objet de connexion
    public static $db;

    //méthode qui crée l'objet de connexion
    ...
    //méthode pour éxécuter une requête SQL
    ...
    //méthode pour récupérer toutes les DATAS d'une seul table 
    ...
    //méthode pour créer une ligne dans une table de la BDD - INUTILISEE!
    ...
    //méthode pour delete un champs d'une ligne d'une table - INUTILISEE!
    ...
    //méthode pour mettre à jour plusieurs champs d'une ligne d'une table - INUTILISEE!
